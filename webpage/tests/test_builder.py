...
from webpage.modules.builder import NormalRecipeBuilder, SpoonacularRecipeBuilder
...
class NormalRecipeBuilderTest(TestCase):
    ...
    def test_build_ingredient(self):
        ...
        self.builder.build_ingredient(ingredient=ingredient,
                                      amount=2,
                                      unit="slice")
    ...
    def test_build_one_equipment(self):
        ...
        equipment = Equipment.objects.create(name="Spoon")
        self.builder.build_equipment(equipment=equipment,
                                     amount=1,
                                     unit="piece")
    ...
    def test_build_nutrition(self):
        ...
        nutrition = Nutrition.objects.create(name="Protein")
        self.builder.build_nutrition(nutrition=nutrition,
                                     amount=30,
                                     unit="grams")
    ...
    def test_build_user(self):
        ...
        new_user = User.objects.create_user(username="new_user",
                                            password="password")
        self.builder.build_user(user=new_user)
    ...
    def test_build_diet(self):
        ...
        diet1 = Diet.objects.create(name="Keto")
        diet2 = Diet.objects.create(name="Vegan")
        self.builder.build_diet(diet=diet1)
        self.builder.build_diet(diet=diet2)
...
class TestSpoonacularRecipeBuilder(TestCase):
    ...
    @patch('requests.get')
    def test_build_step(self, mock_get):
        """Test the build_step method on the SpoonacularRecipeBuilder."""
        mock_response = {
    ...
    def test_build_diet(self, mock_get):
        ...
        self.assertIn(Diet.objects.get(name="Vegan"), self.recipe.diets.all())
        self.assertIn(Diet.objects.get(name="Keto"), self.recipe.diets.all())
