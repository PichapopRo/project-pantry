...
class NutritionModelTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.nutrition = Nutrition.objects.create(name="Protein",
    ...
    def test_nutrition_create(self):
        ...
        self.assertEqual(self.nutrition,
                         Nutrition.objects.get(id=self.nutrition.id))
        self.assertEqual(self.nutrition.name, "Protein")
        self.assertEqual(self.nutrition.spoonacular_id, 12345)
        self.assertTrue(Nutrition.objects.filter(name="Protein",
